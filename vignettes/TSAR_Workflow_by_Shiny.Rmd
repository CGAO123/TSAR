...
library(TSAR)
library(shiny)
load_all('/Users/zhijiang/Desktop/University/Bio Lab/TSARnew')
```
...
```
new feature:
user is able to choose either GAM or beta model for test fit.
```{r, out.width = "400px", echo = FALSE}
knitr::include_graphics("images/beta_model.png")
```
...
analysis_path <- '/Users/zhijiang/Desktop/University/Bio Lab/WT gallic acid and metal/Analysis'


rawData_path <- '/Users/zhijiang/Desktop/University/Bio Lab/WT gallic acid and metal/Raw'
...
runApp(graph_tsar(normalized_tsa_df))
```
