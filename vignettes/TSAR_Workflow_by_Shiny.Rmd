...
Run `na.omit()` on data if error occurs. Three graphing options are allowed, 
...
Upload is limited to 30MB in size, but not count size. After upload, user will 
...
of tsar_data will be prompted. For a full list of well_ID and conditions_ID, 
refer to the helper buttons at the bottom of page.
