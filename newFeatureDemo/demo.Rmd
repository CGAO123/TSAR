...
```{r}
# IMPORTANT: UNCOMMENT one of these for package loading
# uncomment this if you install newest version of TSAR
# library("TSAR")

# uncomment this if you clone newst version of TSAR from GitHub
