...
#merge data
tsar_data <- merge_norm(norm_data, norm_data_rep, 
...
All of the above functions are also wrapped in an interactive window call through graph_tsar(). Simply call function on merged tsar_data and access all graphing features in one window.
